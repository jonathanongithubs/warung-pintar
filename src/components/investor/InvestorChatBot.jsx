...
const InvestorChatBot = () => {
  ...
  const [messages, setMessages] = useState([
    { id: 1, type: 'bot', text: 'Halo! 👋 Ada yang bisa saya bantu tentang investasi di Warung Pintar?' },
  ]);
          ...
          >
            ...
            <div className="p-3 text-white" style={{ backgroundColor: '#114B3A' }}>
              <div className="flex items-center gap-2">
                ...
                <div>
                  <h3 className="font-semibold text-sm">Asisten Investor</h3>
                  <span className="text-[10px] text-white/60">Bantuan seputar investasi UMKM</span>
                </div>
              </div>
            </div>
